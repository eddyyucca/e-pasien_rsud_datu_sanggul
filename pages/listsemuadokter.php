     ...
     <div class="container">
          <div class="row">
               ...
               if (!isset($_SESSION["semuadokter"])) {
                    $datadokter       = "";
                    $querysemuadokter = bukaquery("select dokter.kd_dokter,left(dokter.nm_dokter,50) as dokter,spesialis.nm_sps,dokter.no_ijn_praktek,pegawai.photo,dokter.no_telp from dokter inner join spesialis on dokter.kd_sps=spesialis.kd_sps inner join pegawai on dokter.kd_dokter=pegawai.nik where dokter.status='1' and dokter.kd_dokter<>'-' order by spesialis.nm_sps");
